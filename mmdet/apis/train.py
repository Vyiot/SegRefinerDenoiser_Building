...
def train_detector(model,
    ...
    if validate:
        ...
        # Use OEMBuildingEvalHook for OEM Building datasets
        from mmdet.core import OEMBuildingEvalHook
        eval_interval = eval_cfg.get('interval', 5000)
        eval_data_root = eval_cfg.get('data_root', cfg.data.val.data_root)
